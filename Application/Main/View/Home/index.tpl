...
<html lang="zh-cn">
  ...
  <body style="padding-top: 50px;padding-bottom: 20px;">
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>欢迎使用SAE故障诊断工具</h1>
        <p>成长之路，难免遇到挫折，希望这个工具能让你尽快从挫折中站起来。</p>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          ...
          <p><a href="{:U('Domain/start')}" class="btn btn-primary" role="button">开始诊断</a></p>
        </div>
        <div class="col-md-4">
          <h2>微信公众平台相关</h2>
          <p>Token验证通不过等问题</p>
          <p><a class="btn btn-default" role="button" disabled="disabled">敬请期待</a></p>
        </div>
      </div>
      <hr>
      <footer>
